...
class Environment:
    def __init__(self,obstacles):
        ...
        self.wheel_positions = np.array([
            [+50/ 2, +30/ 3],   # Front left
            [+50/ 2, -30/ 3],  # Front right
            [-50/ 2, 0]                     # Rear center
        ])
        ...
        #                             [-self.car_length/2, -self.car_width/2],
        #                             [-self.car_length/2, +self.car_width/2]], 
        #                             np.int32)  for 4 wheeler

        self.car_struct = np.array([
                    [+self.car_length / 2, -self.car_width / 2], # Front left
                    [+self.car_length / 2, +self.car_width / 2], #  right corner
                    [-self.car_length / 2, 0 ]  # rear
                ], np.int32)
        ...
        # self.background[10:1000+20*self.margin:10,:] = np.array([0, 0, 0])
        # self.background[:,10:1000+20*self.margin:10] = np.array([0, 0, 0])
...
class Parking1:
    def __init__(self, car_pos):
        ...
        self.walls = [[50,i] for i in range(-5,90) ]+\
